                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-sm btn-success add_calendar"> Tambah Event Baru
...
<script type="text/javascript" src="<?php echo base_url().'assets\vendor\fullcalendar\fullcalendar.min.js'; ?>"></script>      
